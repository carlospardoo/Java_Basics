...
public class TestDayOfTheProgrammer {

    public static void main(String[] args) {
        String fecha = "";

        fecha = dayOfProgrammer(1800);
        System.out.println(fecha);

//        fecha = dayOfProgrammer(1801);
//        System.out.println(fecha);

        fecha = dayOfProgrammer(1916);
        System.out.println(fecha);

        fecha = dayOfProgrammer(2017);
        System.out.println(fecha);

        fecha = dayOfProgrammer(2016);
        System.out.println(fecha);

        fecha = dayOfProgrammer(1919);
        System.out.println(fecha);

        fecha = dayOfProgrammer(1918);
        System.out.println(fecha);
    }

//    public static String dayOfProgrammer(int year){
//
//        LocalDate dateAux = LocalDate.ofYearDay(year, 256);
...
//
//        if(year < 1918){ //JULIAN
//            dateAux = (year % 4 == 0) ? dateAux.minusDays(1) : dateAux;
////            dateAux = dateAux.minusDays(1);
//
//        }
//        else if(year > 1919){ //GREGORIAN
////            dateAux = (year % 400 == 0 || (year % 4 == 0 && year % 100 != 0 ) ) ? dateAux.plusDays(1) : dateAux ;
//        }
//        else{ //TRANSITION - 31 JAN TO 14 FEB
//            dateAux = dateAux.minusDays(14);
//        }
//        date = dateAux.format(dtf);
//        return date;
//    }
    ...
    public static String dayOfProgrammer(int year){
        ...
        if(year < 1918){ //JULIAN
            day = (year % 4 == 0) ? day - 1 : day;

        }
        else if(year >= 1919){ //GREGORIAN
            day = (year % 400 == 0 || (year % 4 == 0 && year % 100 != 0 ) ) ? day - 1 : day ;
        }
        else{ //TRANSITION - 31 JAN TO 14 FEB
            day = 26;
        }
